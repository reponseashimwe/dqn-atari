...
| | **Set 6** – lr=1e-4, gamma=0.99, batch=512, eps_start=1.0, eps_end=0.05, eps_decay=100000 | Very large batch to stabilize noisy MLP gradients; long epsilon decay for exploration. | **0.4** | Moderate/Poor |
| | **Set 7** – lr=2e-4, gamma=0.99, batch=64, eps_start=1.0, eps_end=0.01, eps_decay=50000 | Higher LR with aggressive exploitation; possible instability but faster learning. | **0.6** | Moderate |
| | **Set 8** – lr=5e-5, gamma=0.995, batch=128, eps_start=1.0, eps_end=0.1, eps_decay=200000 | Very conservative LR + high gamma; slow but stable long-term improvement expected. | **0.8** | Moderate/Good |
| | **Set 9** – lr=3e-4, gamma=0.97, batch=32, eps_start=1.0, eps_end=0.05, eps_decay=30000 | Aggressive LR + low gamma = unstable and short-sighted learning. | **0.5** | Poor |
| | **Set 10** – lr=1e-4, gamma=0.999, batch=128, eps_start=1.0, eps_end=0.02, eps_decay=250000 | Very high gamma + large batch; strong long‑horizon behavior. Best predicted MLP performance. | **1.3** | Good/Best |
